...
/**
 * @Description: 第二个JPA数据源自定义配置
 * 
 * @author zhangyue
 * @since 2018-01-03 15:17:09
 */
@Configuration
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactorySecondary", transactionManagerRef = "transactionManagerSecondary", 
		basePackages = { "com.yue.springboot.multi.datasource.demo.domain.secondary" })
public class SecondaryJPADataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.yue.springboot.multi.datasource.demo.domain") //设置实体类所在位置
